...
return {
	...
	config = function()
		...
		map("n", "<leader>ffa", builtin.find_files)
		map("n", "<leader>ffi", ":Telescope find_files cwd=")
		map("n", "<leader>gra", builtin.live_grep)
		map("n", "<leader>gri", ":Telescope live_grep cwd=")
		map("n", "<leader>gsi", ":Telescope grep_string cwd=")
