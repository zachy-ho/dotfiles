...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    ...
    keys = { { "", "<leader>nf" }, { "", "<leader>nt" }, { "", "<leader>nb" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'markdown-preview.nvim', 'vim-easy-align'}, { ft = "markdown" }, _G.packer_plugins)]]
