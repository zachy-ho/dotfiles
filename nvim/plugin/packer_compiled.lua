...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-buffer", "nvim-autopairs", "cmp-nvim-lua" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'vim-easy-align', 'markdown-preview.nvim', 'headlines.nvim'}, { ft = "markdown" }, _G.packer_plugins)]]
